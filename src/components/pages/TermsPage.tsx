  ...
  const sections = [
    {
      title: '1. 服务条款的接受',
      content: [
        '欢迎使用tkgo.vip平台。通过访问或使用我们的服务，您同意受本服务条款的约束。',
    ...
    },
    {
      title: '2. 服务描述',
      content: [
        'tkgo.vip是一个连接品牌方与TikTok达人的专业直播带货平台。',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              请仔细阅读以下服务条款。使用tkgo.vip平台即表示您同意遵守这些条款。
            </p>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-amber-700">
                本服务条款是您与tkgo.vip之间的法律协议。请在使用我们的服务前仔细阅读并理解所有条款。
